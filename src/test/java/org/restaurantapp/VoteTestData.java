...
public class VoteTestData {
    public static TestMatcher<Vote> VOTE_MATCHER = TestMatcher.usingIgnoringFieldsComparator();
    ...
    public static final Vote adminMeal1 = new Vote(ADMIN_VOTE_ID, of(2020, Month.JANUARY, 31, 14, 0));
    public static final Vote adminMeal2 = new Vote(ADMIN_VOTE_ID + 1, of(2020, Month.JANUARY, 31, 21, 0));
